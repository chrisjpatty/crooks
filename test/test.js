...
describe("useLocalStorage", () => {
  ...
  test("localStorage updates correctly", async () => {
    const { getByText } = render(<LocalStorageTest />);
    fireEvent.click(getByText("UPDATE"));
    expect(localStorage.setItem).toHaveBeenLastCalledWith("FRUIT", '"pear"');
  });
  test("localStorage callback updates correctly", async () => {
    const { getByText } = render(<LocalStorageTest />);
...
describe("useFiler", () => {
  test("Files intialize correctly", async () => {
    const { getByText } = render(<FilerTest getState={getState} />);
    expect(typeof state).toBe("object");
    expect(state).toMatchObject({});
  });
  test("File adds correctly", async () => {
    const { getByText } = render(<FilerTest getState={getState} />);
  ...
  test("File removes correctly", async () => {
    const { getByText } = render(<FilerTest getState={getState} />);
    fireEvent.click(getByText("ADD"));
    expect(Object.keys(state).length).toBe(1);
  ...
  test("File updates correctly", async () => {
    const { getByText } = render(<FilerTest getState={getState} />);
    fireEvent.click(getByText("ADD"));
    expect(Object.keys(state).length).toBe(1);
  ...
  test("File update callback updates correctly", async () => {
    const { getByText } = render(<FilerTest getState={getState} />);
    fireEvent.click(getByText("ADD"));
    expect(Object.keys(state).length).toBe(1);
    const { modified, created } = state[Object.keys(state)[0]];
  ...
  test("Files clear correctly", async () => {
    const { getByText } = render(<FilerTest getState={getState} />);
    fireEvent.click(getByText("ADD"));
    expect(Object.keys(state).length).toBe(1);
    fireEvent.click(getByText("ADD"));
...
describe("useOnClickOutside", () => {
  ...
  test("Click without ref doesn't trigger handler", async () => {
    const { getByText } = render(<OnClickOutside noref />);
    getByText("apple");
    fireEvent.click(getByText("MODAL"));
    getByText("apple");
  });
  test("Click outside triggers handler", async () => {
    const { getByText } = render(<OnClickOutside />);
    getByText("apple");
    fireEvent.click(getByText("OUTSIDE"));
    getByText("pear");
  });
  test("Click outside doesn't triggers handler when disabled", async () => {
...
describe("useKeyboardShortcut", () => {
  test("Handler initializes correctly", async () => {
    const { getByText } = render(<KeyboardShortcut />);
    getByText("apple");
  });
  test('Pressing "a" triggers handler', async () => {
    const { getByText } = render(<KeyboardShortcut />);
    getByText("apple");
    act(() => {
  ...
  test('Pressing "a" doesn\'t trigger handler when disabled', async () => {
  ...
  test('Pressing "c" doesn\'t trigger handler', async () => {
    const { getByText } = render(<KeyboardShortcut />);
    getByText("apple");
    act(() => {
  ...
  test("Enable/disable functions work correctly", async () => {
    const { getByText } = render(<KeyboardShortcut />);
    getByText("apple");
